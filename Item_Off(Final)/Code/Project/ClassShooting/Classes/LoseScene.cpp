...
CCScene* CLoseScene::scene()
{
    // 'scene' is an autorelease object
    CCScene *scene = CCScene::create();
    
    // 'layer' is an autorelease object
    CLoseScene *layer = CLoseScene::create();
...
bool CLoseScene::init()
{
    ...
    CCMenuItemImage *pCloseItem = CCMenuItemImage::create(
                                        ...
                                        "img/Go_Main_1.png",
                                        this,
                                        menu_selector(CLoseScene::menuCloseCallback));
    ...
    CCSprite* pSprite = CCSprite::create("img/ls_bg.png");
...
void CLoseScene::menuCloseCallback(CCObject* pSender)
{
...
CCTransitionScene* CLoseScene::createTransition(int nIndex, float t, CCScene* s)
{
